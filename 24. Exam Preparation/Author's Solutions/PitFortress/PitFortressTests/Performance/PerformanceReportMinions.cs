    ...
    public class PerformanceReportMinions : BaseTestClass
    {
        ...
        public void PerformanceReportMinions_WithRandomAmounts1()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/ReportMinions/report.0.result.txt")))
                //{
        ...
        public void PerformanceReportMinions_WithRandomAmounts2()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/ReportMinions/report.1.result.txt")))
                //{
                //    foreach (var minion in minions)
                //    {
                //        writer.WriteLine("{0} {1} {2}",minion.XCoordinate,minion.Id, minion.Health);
        ...
        public void PerformanceReportMinions_WithRandomAmounts3()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/ReportMinions/report.2.result.txt")))
                //{
                //    foreach (var minion in minions)
                //    {
                //        writer.WriteLine("{0} {1} {2}",minion.XCoordinate,minion.Id, minion.Health);
        ...
        public void PerformanceReportMinions_WithRandomAmounts4()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/ReportMinions/report.3.result.txt")))
                //{
                //    foreach (var minion in minions)
                //    {
                //        writer.WriteLine("{0} {1} {2}", minion.XCoordinate, minion.Id, minion.Health);
        ...
        public void PerformanceReportMinions_WithRandomAmounts5()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/ReportMinions/report.4.result.txt")))
                //{
                //    foreach (var minion in minions)
                //    {
                //        writer.WriteLine("{0} {1} {2}", minion.XCoordinate, minion.Id, minion.Health);
