    ...
    public class PerformanceSetMine : BaseTestClass
    {
        ...
        public void PerformanceSetMine_WithRandomAmounts1()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/SetMine/mine.0.result.txt")))
                //{
        ...
        public void PerformanceSetMine_WithRandomAmounts2()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/SetMine/mine.1.result.txt")))
                //{
                //    foreach (var mine in mines)
                //    {
                //        writer.WriteLine("{0} {1} {2} {3} {4}", mine.Delay, mine.Id, mine.XCoordinate, mine.Damage, mine.Player.Name);
        ...
        public void PerformanceSetMine_WithRandomAmounts3()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/SetMine/mine.2.result.txt")))
                //{
                //    foreach (var mine in mines)
                //    {
                //        writer.WriteLine("{0} {1} {2} {3} {4}", mine.Delay, mine.Id, mine.XCoordinate, mine.Damage, mine.Player.Name);
        ...
        public void PerformanceSetMine_WithRandomAmounts4()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/SetMine/mine.3.result.txt")))
                //{
                //    foreach (var mine in mines)
                //    {
                //        writer.WriteLine("{0} {1} {2} {3} {4}", mine.Delay, mine.Id, mine.XCoordinate, mine.Damage, mine.Player.Name);
        ...
        public void PerformanceSetMine_WithRandomAmounts5()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/SetMine/mine.4.result.txt")))
                //{
                //    foreach (var mine in mines)
                //    {
                //        writer.WriteLine("{0} {1} {2} {3} {4}", mine.Delay, mine.Id, mine.XCoordinate, mine.Damage, mine.Player.Name);
