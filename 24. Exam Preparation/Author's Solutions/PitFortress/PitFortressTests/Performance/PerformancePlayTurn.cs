    ...
    public class PerformancePlayTurn : BaseTestClass
    {
        ...
        public void PerformancePlayTurn_WithRandomAmounts1()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/PlayTurn/turn.0.result.txt")))
                //{
                //    foreach (var player in topPlayers)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
                //    }
                ...
                //    {
                //        writer.WriteLine("{0} {1} {2}", minion.XCoordinate, minion.Id, minion.Health);
                //    }
        ...
        public void PerformancePlayTurn_WithRandomAmounts2()
        {
            ...
            using (StreamReader reader = new StreamReader(input2))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/PlayTurn/turn.1.result.txt")))
                //{
                //    foreach (var player in topPlayers)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformancePlayTurn_WithRandomAmounts3()
        {
            ...
            using (StreamReader reader = new StreamReader(input2))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/PlayTurn/turn.2.result.txt")))
                //{
                //    foreach (var player in topPlayers)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformancePlayTurn_WithRandomAmounts4()
        {
            ...
            using (StreamReader reader = new StreamReader(input4))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/PlayTurn/turn.3.result.txt")))
                //{
                //    foreach (var player in topPlayers)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformancePlayTurn_WithRandomAmounts5()
        {
            ...
            using (StreamReader reader = new StreamReader(input5))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/PlayTurn/turn.4.result.txt")))
                //{
                //    foreach (var player in topPlayers)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
