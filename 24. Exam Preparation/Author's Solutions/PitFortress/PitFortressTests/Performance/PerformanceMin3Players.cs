    ...
    public class PerformanceMin3Players : BaseTestClass
    {
        ...
        public void PerformanceMin3Players_WithRandomAmounts1()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/Min3Players/min3.0.result.txt")))
                //{
        ...
        public void PerformanceMin3Players_WithRandomAmounts2()
        {
            ...
            using (StreamReader reader = new StreamReader(input2))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/Min3Players/min3.1.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformanceMin3Players_WithRandomAmounts3()
        {
            ...
            using (StreamReader reader = new StreamReader(input2))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/Min3Players/min3.2.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformanceMin3Players_WithRandomAmounts4()
        {
            ...
            using (StreamReader reader = new StreamReader(input4))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/Min3Players/min3.3.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformanceMin3Players_WithRandomAmounts5()
        {
            ...
            using (StreamReader reader = new StreamReader(input5))
            {
                ...
                //using (
                //    StreamWriter writer = new StreamWriter(File.Create("../../Results/Min3Players/min3.4.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
