    ...
    public class PerformanceTop3Players : BaseTestClass
    {
        ...
        public void PerformanceTop3Players_WithRandomAmounts1()
        {
            ...
            using (StreamReader reader = new StreamReader(input))
            {
                ...
                //using (
                //    StreamWriter writer =
                //        new StreamWriter(File.Create("../../Results/Top3Players/top3.0.result.txt")))
                //{
        ...
        public void PerformanceTop3Players_WithRandomAmounts2()
        {
            ...
            using (StreamReader reader = new StreamReader(input2))
            {
                ...
                //using (
                //   StreamWriter writer =
                //       new StreamWriter(File.Create("../../Results/Top3Players/top3.1.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformanceTop3Players_WithRandomAmounts3()
        {
            ...
            using (StreamReader reader = new StreamReader(input2))
            {
                ...
                //using (
                //   StreamWriter writer =
                //       new StreamWriter(File.Create("../../Results/Top3Players/top3.2.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformanceTop3Players_WithRandomAmounts4()
        {
            ...
            using (StreamReader reader = new StreamReader(input4))
            {
                ...
                //using (
                //   StreamWriter writer =
                //       new StreamWriter(File.Create("../../Results/Top3Players/top3.3.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
        ...
        public void PerformanceTop3Players_WithRandomAmounts5()
        {
            ...
            using (StreamReader reader = new StreamReader(input5))
            {
                ...
                //using (
                //   StreamWriter writer =
                //       new StreamWriter(File.Create("../../Results/Top3Players/top3.4.result.txt")))
                //{
                //    foreach (var player in players)
                //    {
                //        writer.WriteLine("{0} {1} {2}", player.Name, player.Radius, player.Score);
